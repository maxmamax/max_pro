...
<div class="panel panel-default">
  <div class="panel-heading"><h1><span class="glyphicon glyphicon-list"></span> ข้อมูลประเมินการฝึกงานนักศึกษา</h1></div>
...
<?php if($fet['con_status'] == '1'){ ?>
   <td>
  <form action="index.php?page=evaluation_show" method="post">
