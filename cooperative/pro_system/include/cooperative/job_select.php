...
<div class="panel panel-default">
  <div class="panel-heading"><h1><span class="glyphicon glyphicon-list" aria-hidden="true"></span> ข้อมูลการจองตำแหน่งงานนักศึกษา</h1></div>
...
<table class="table table-bordered table-hover">
  ...
  <tr class="f1">
    <td >ลำดับ</td>
    <td >ตำแหน่งงาน</td>
    <td >จำนวนนักศึกษามาสมัคร</td>
  </tr>
</thead>
<?php
$sql = "SELECT * FROM tb_register_job a ,  tb_position b WHERE  a.coop_keyf = '".$_SESSION['session_key']."' AND a.position_keyf = b.position_key GROUP BY position_keyf  ";
...
$sql1 = mysql_query("SELECT count(position_keyf) as num FROM tb_register_job WHERE position_keyf = '".$fet['position_key']."' ");
$fet1 = mysql_fetch_array($sql1);
?>
  <tr class="f2">
    <td ><?php echo  (($Page-1)*10)+$i ; ?></td>
    <td ><a href="index.php?page=job_student&key=<?php echo $fet['position_key']; ?>"><?php echo $fet['position_name']; ?></a></td>
