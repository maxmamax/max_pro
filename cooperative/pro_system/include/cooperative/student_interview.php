...
<div class="panel panel-default">
  <div class="panel-heading"><h1><span class="glyphicon glyphicon-list" aria-hidden="true"></span> ข้อมูลกำหนดการสัมภาษณ์นักศึกษา</h1></div>
...
<?php
$sql = "SELECT * FROM tb_position a ,  tb_register_job b   WHERE  a.position_key = b.position_keyf AND  b.coop_keyf = '".$_SESSION['session_key']."' AND b.job_status = '1' AND a.coop_keyf = '".$_SESSION['session_key']."'  GROUP BY position_keyf ";
...
$sql1 = mysql_query("SELECT count(inter_id) as num FROM  tb_interview  WHERE position_keyf = '".$fet['position_key']."' ");
$fet1 = mysql_fetch_array($sql1);
?>
  <tr class="f2">
    <td ><?php echo  (($Page-1)*10)+$i ; ?></td>
    <td ><a href="index.php?page=job_studentinterview&key=<?php echo $fet['position_key']; ?>"><?php echo $fet['position_name']; ?></a></td>
