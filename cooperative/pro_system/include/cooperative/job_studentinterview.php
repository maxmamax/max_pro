...
<?php if($_SESSION['session_status_menu'] == 'cooperative' && $_GET['position'] == '' ){
  $sql = mysql_query("SELECT * FROM  tb_register_job a ,  tb_student b , tb_position c  WHERE a.student_keyf = b.student_key AND a.position_keyf = c.position_key AND a.coop_keyf = '".$_SESSION['session_key']."' AND a.position_keyf = '".$_GET['key']."' AND a.job_status = '1' ");
  $fet = mysql_fetch_array($sql);
?>


<div class="panel panel-default">
  <div class="panel-heading"><h1>ข้อมูลกำหนดการสัมภาษณ์นักศึกษา (<?php echo $fet['position_name']; ?>)
    <form class="" action="include/report1/report_student.php" method="post" target="_blank" style="margin-top:10px;">
...
while($fet = mysql_fetch_array($sql)){ ?>
  <tr class="f1">
    ...
    echo "ผ่านการสอบสัมภาษณ์";
    }else if($fet['job_status'] == '3'){
    echo "ไม่ผ่านการสอบสัมภาษณ์";
    }
