...
?>
<?php if($_SESSION['session_status_menu'] == 'staff' && $_GET['position'] != ''  ){ ?>

<div class="panel panel-default">
  <div class="panel-heading"><h1>ตำแหน่งงาน</h1></div>
  <div class="panel-body">
    <?php if($_SESSION['session_status_menu'] == 'staff'  && $_GET['position'] != '' ){
  $sql = mysql_query("SELECT * FROM tb_position as a INNER JOIN tb_cooperative as b ON (a.coop_keyf = b.coop_key) INNER JOIN tb_type_ope e ON (b.coop_typef = e.type_key)  WHERE position_key = '".$_GET['position']."'  ");
