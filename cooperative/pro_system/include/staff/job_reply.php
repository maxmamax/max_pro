...
<div class="panel panel-default">
  <div class="panel-heading"><h1><span class="glyphicon glyphicon-list"></span> ข้อมูลสถานประกอบการสนใจนักศึกษา</h1></div>
...
<?php if($fet['con_status'] == '1'){ ?>
   <td>
  <form action="index.php?page=data_jobreply" method="post">
...
<?php }else{ ?>
  ...
  <button id="id_faculty" class="btn btn-success" type="submit" name="id" value="<?php echo $fet1['course_key']; ?>">ดูข้อมูล</button>
  </form>
   </td>
<?php }?>
 </tr>
...
<script type="text/javascript">
  $("[id^=id_faculty]").click(function(){
    var id = $(this).val();
    $.post('include/staff/data_jobreply.php',{
      id : id,
      status : 'f'
    },function(data){
      $("#show_data").html(data);
