<div class="panel panel-default">
  <div class="panel-heading f1"><span class="glyphicon glyphicon-list" aria-hidden="true"></span> ข้อมูลประกาศนัดสัมภาษณ์งาน</div>
  <div class="panel-body">
    ...
    <table class="table table-bordered table-hover">
      ...
      <?php
      $sql = "SELECT * FROM  tb_register_job a , tb_position b WHERE job_status = '1' AND a.position_keyf = b.position_key GROUP BY position_keyf  ";
