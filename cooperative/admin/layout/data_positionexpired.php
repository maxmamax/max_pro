...
<form class="" action="" method="post" name="form1" id="form_delete">
...
if($_POST['r'] == ""){
  ...
  $q = "DATEDIFF(NOW(),a.position_dateL) >= '".$_POST['r']."' ";
}
$i=1;
$sql = "SELECT * FROM tb_position as a INNER JOIN tb_cooperative as b ON (a.coop_keyf = b.coop_key)  WHERE $q ";
...
<input type="button" name="" value="ลบข้อมูล" id="delete" class="btn btn-danger">
</form>
</div>
